...
public:
    ...
    void createComputePipeline() {
        ...
        */
        ...
        uint32_t* code = readFile(filelength, "shaders/comp_normal.spv");
    ...
    void createCommandBuffer() {
        ...
        */
        ...
        uint32_t bar = 1;
        vkCmdPushConstants(commandBuffer, pipelineLayout, VK_SHADER_STAGE_COMPUTE_BIT, 0, sizeof(bar), &bar);
        ...
        */
        vkCmdDispatch(commandBuffer, (uint32_t)ceil((WIDTH * HEIGHT) / float(WORKGROUP_SIZE)), 1, 1);
